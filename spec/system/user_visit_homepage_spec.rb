...
describe 'User visit homepage' do
  context 'and searches a cep' do
    ...
    it 'that doesn\'t exist' do
      ...
      expect(page).to have_content 'O CEP 12345-678 não foi encontrado! Verifique o código.'
    end
    ...
    it 'that is already in the database' do
      cep = CepStat.create! cep: '01153000', address: 'Rua Vitorino Carmilo', state: 'SP', city: 'São Paulo',
